  ...
  return (
    <div className="p-6 mt-2 space-y-6 max-w-7xl mx-auto font-semibold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
        {/* Order Summary */}
        <div className="bg-gray-50 rounded-lg p-2">
          <h2 className="font-bold text-lg border-b pb-1 mb-2">Order Summary</h2>
          <div className="mt-2 space-y-2">
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              <span className="text-gray-500 font-semibold">Product Savings</span>
              <span className="text-green-600">
                {calculateTotalDiscountPercentage(orderDetails.productDetails)}% OFF
              </span>
            </div>
            ...
            {orderDetails.discountAmount > 0 && (
                <div className="flex justify-between bg-green-50 p-1 rounded">
                    ...
                    <span className="text-green-700 font-bold">
                        - {displayINRCurrency(orderDetails.discountAmount)}
                    </span>
                </div>
            )}
            ...
            <div className="flex justify-between">
              ...
              <span className={orderDetails.shippingOption === "Free" ? "text-green-600 font-bold" : ""}>
            ...
            <div className="flex justify-between font-extrabold text-lg border-t pt-2 mt-2 text-gray-900">
              <span>Total Paid</span>
              <span>{displayINRCurrency(orderDetails.totalAmount)}</span>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <div className="flex justify-between">
              ...
              <button
                onClick={handleCancelOrder}
                type="button" className="flex items-center rounded-lg bg-red-500 text-white px-4 py-2" disabled={isRequestClick}>
                {isRequestClick && <svg className="mr-3 h-5 w-5 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-96">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                onClick={handleSubmitReturn}
                type="button" className="flex items-center rounded-lg bg-yellow-500 text-white px-4 py-2" disabled={isRequestClick}>
                {isRequestClick && <svg className="mr-3 h-5 w-5 animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>}
