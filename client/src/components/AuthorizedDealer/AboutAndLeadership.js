...
import About from "../../assest/About/AboutRelda.webp";
// import TrustSection from "../../assest/About/TrustSection.webp";
  ...
  const purposeCards = [
    {
      ...
      desc: "Superior quality and long-lasting performance",
      icon: <ShieldCheck className="w-5 h-5" />,
    },
    {
      title: "Modern Tech",
      desc: "Modern technology with practical functionality",
      icon: <Cpu className="w-5 h-5" />,
    },
    {
      title: "Energy Efficient",
      desc: "Energy efficiency and reliability",
      icon: <Leaf className="w-5 h-5" />,
    },
    {
      title: "Customer Support",
      desc: "Exceptional customer support",
      icon: <UserRound className="w-5 h-5" />,
    },
    {
      title: "Value Innovation",
      desc: "Value-driven innovation",
  ...
  return (
    <div className="bg-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-brand-textMuted text-lg leading-relaxed">
              At RELDA, we believe every home deserves appliances that combine
              innovation, quality, durability, and value. Our mission is to
              deliver reliable home appliance solutions that simplify everyday
              living while maintaining the highest standards of performance and
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            ...
            <div className="absolute bottom-6 right-6 bg-white px-6 py-4 rounded-2xl shadow-xl flex items-center gap-3">
              ...
              <div>
                <p className="text-brand-primary text-xl font-bold leading-none">
                  15+
                </p>
          ...
          >
            <h3 className="text-[#1A1A1A] text-5xl font-bold mb-2">
              Mr. Paul Daniel K
            </h3>
            <p className="text-brand-primary text-xl font-bold mb-8">
              Director & CEO
            </p>

            <div className="text-brand-textMuted text-lg leading-relaxed space-y-6">
              <p>
                With over 15 years of illustrious leadership in the consumer
                durables industry, Mr. Paul Daniel K has been at the forefront
                of driving operational excellence and market growth for some of
                India's most iconic brands.
              </p>
              <p>
                His visionary approach and deep understanding of the Indian
                consumer landscape were honed through pivotal roles at IFB, LG,
                Havells, and Bluestar. This extensive experience serves as the
                bedrock of RELDA's commitment to quality and innovation.
              </p>
            </div>

            <div className="mt-12">
              <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] mb-6">
                Industry Experience Across India's Leading Consumer Durable
                Brands
              </p>
              <div className="flex flex-wrap gap-4">
                {previousBrands.map((brand) => (
                  <div
                    key={brand}
                    className="bg-gray-50 px-8 py-4 rounded-xl border border-gray-100 text-gray-400 font-bold text-sm tracking-widest"
                  >
                    {brand}
                  </div>
                ))}
        ...
        >
          ...
          <div className="lg:w-1/2 text-white">
            ...
            <p className="text-white/80 text-lg lg:text-xl leading-relaxed max-w-md">
              This rich industry experience inspired the creation of RELDA, a
              brand built on a simple vision: to make premium-quality appliances
              accessible, dependable, and affordable for every Indian household.
            </p>
          </div>
      ...
      <section className="py-16 bg-[#F8FAFF]">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-brand-primary text-4xl md:text-5xl font-bold mb-4">
              Every RELDA Product is Built with Purpose
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {purposeCards.map((card, index) => (
              ...
              >
                ...
                <h4 className="text-gray-900 font-bold text-lg mb-3 leading-tight">
                  {card.title}
                </h4>
        ...
        <div className="w-full flex justify-center">
          <button
            ...
            type="button"
            className="flex justify-center mt-12 text-brand-primary bg-red-100 py-4 px-8 rounded-full font-bold text-lg hover:bg-brand-primary hover:text-white"
          >
            Read Our Story
          </button>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-brand-textMuted text-lg leading-relaxed mb-10">
              At RELDA, we don't just manufacture appliances, we build trust
              that lasts for years. Our commitment is to continuously innovate
              and provide products that enhance comfort, convenience, and
              everyday life.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              {[
                ...
                <div
                  key={i}
                  className="bg-white px-5 py-2.5 rounded-full flex items-center gap-2 shadow-sm text-gray-700 font-semibold text-sm"
                >
      ...
      {/* <section className="pt-16 px-4 lg:px-8 text-center bg-white">
        ...
        >
          <h2 className="text-brand-primary text-5xl md:text-6xl font-bold mb-8">
            Our Vision
          </h2>
          <p className="text-brand-textMuted text-xl leading-relaxed">
            As we grow, our vision is to establish RELDA as one of India's most
            trusted home appliance brands, delivering world-class products
            backed by industry expertise and a customer-first approach.
          </p>
        </motion.div>
      </section> */}
    </div>
