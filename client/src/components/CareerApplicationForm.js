...
const CareerApplicationForm = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center px-4 pt-20">
      <div className="bg-white w-full max-w-4xl rounded-xl shadow-md relative max-h-[90vh] overflow-y-auto">
