...
import Img from "../../assest/DistributorImages/Hero.webp";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#000000] leading-tight mb-5">
              Become a RELDA <br className="hidden sm:block" />
              Authorized <br className="hidden sm:block" />
              Distributor
            </h1>

            <p className="text-brand-textMuted text-base md:text-lg max-w-md mx-auto lg:mx-0 mb-8">
              Join a network of engineering excellence. Partner with RELDA to
              bring world-class, affordable luxury home appliances to every
              corner of India.
            </p>
          ...
          >
            <div className="rounded-2xl overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.3),0_0_40px_-10px_rgba(212,175,55,0.15)] hover:shadow-[0_25px_70px_-15px_rgba(0,0,0,0.4),0_0_50px_-10px_rgba(212,175,55,0.25)] transition-shadow duration-500">
              <img
                src={Img}
                alt="Become a RELDA Authorized Distributor"
