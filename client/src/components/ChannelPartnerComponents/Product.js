  ...
  return (
    <section className="relative bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1536px] mx-auto px-3 sm:px-6 md:px-8 lg:px-12 pt-14 pb-10 sm:pt-16 sm:pb-14 md:pt-[72px] md:pb-16 lg:pt-20 lg:pb-20">
        ...
        {/* Second Row - centered */}
        <div className="mt-4 sm:mt-5 lg:mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 sm:max-w-[calc(66.666%+20px)] sm:mx-auto lg:max-w-[calc(66.666%+24px)] lg:gap-6">
